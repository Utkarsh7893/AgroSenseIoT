...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (($username === $valid_username && $password === $valid_password)||($username===$valid_username_0&&$password===$valid_password_0)) {
        ...
        header("Location: /mycomponents/dashboard.html");
        exit();
    } else {
        echo "<!DOCTYPE html>
        <html>
        <head>
            ...
            <style>
                body { font-family: sans-serif; background-image: url(/img/image8.jpeg); background-repeat: no-repeat; background-size: cover; background-position: center; height: 100vh;}
